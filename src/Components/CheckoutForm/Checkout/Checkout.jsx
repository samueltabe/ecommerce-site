...
const Checkout = ({cart, onCaptureCheckout, order, error}) => {
    ...
    : <PaymentForm shippingData={shippingData} checkoutToken={checkoutToken} nextStep={nextStep} backtStep={backtStep} onCaptureCheckout={onCaptureCheckout} timeout={timeout}/>
